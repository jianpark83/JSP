...
//	String url = "jdbc:oracle:thin:@localhost:49161:xe"; => oracle
	String url = "jdbc:mysql://localhost:3306/shopdb";  //mysql
	String uid = "testuser";
	String pass = "1234";
...
<body>
	...
	try{
		//1. 드라이브 로드(객체 생성)
		Class.forName("com.mysql.cj.jdbc.Driver");  //mysql-connector-j-8.3.0.jar이 있어야 실행 가능!!
